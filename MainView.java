...
public class MainView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MainView (Context context) {
        ...
        Assets.sound_getready = Assets.sp.load(context, R.raw.get_ready, 1);
        Assets.sound_squish1 = Assets.sp.load(context, R.raw.squish1, 1);
        Assets.sound_squish2 = Assets.sp.load(context, R.raw.squish2, 1);
        Assets.sound_squish3 = Assets.sp.load(context, R.raw.squish3, 1);
        Assets.sound_thump = Assets.sp.load(context, R.raw.thud, 1);
        Assets.sound_over = Assets.sp.load(context, R.raw.game_over, 1);
        Assets.sound_record = Assets.sp.load(context, R.raw.record, 1);
